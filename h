<body>
  <div style="--total: 12;" class="circle-wrapper">
   ...
   <p class="absolute bottom-4 right-4 text-white mt-4 text-sm">Looking for a <a href="https://codepen.io/cbolson/pen/vYMrwvy" class="text-orange-500 hover:underline" target="_parent">Tawilwind version</a>?
